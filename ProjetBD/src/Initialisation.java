...
public class Initialisation {
	public static void initBase (Connection conn) throws SQLException {
		...
		req.insertCategorie("Velo", 5, 1, 10);
		req.insertCategorie("VeloElec", 5, 2, 20);
		req.insertCategorie("VoitureElec", 5, 4, 40);
		req.insertCategorie("VeloRemork", 5, 3, 30);
		req.insertCategorie("Utilitaire", 5, 5, 50);
		...
		req.insertPlacesLibres("Patate", 12, "Uitilitaire");
		...
		req.insertAbonnes(2, "Le Net", "Dorian", "04-06-1994", "3 rue Gabriel Peri 38000 Grenoble");
